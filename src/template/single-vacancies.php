      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          if ( have_rows( $vacancies_list_block ) ) {
              while ( have_rows( $vacancies_list_block ) ) { the_row(); ?>
                <div class="vacancies__list-block">
                  <!-- tite -->
                  <div class="vacancies__list-block-title"><?php the_sub_field( $vacancies_list_title ); ?></div>
                  <!-- list -->
                  <?php if ( have_rows( $vacancies_list ) ) { ?>
                    <ul class="vacancies__list franchise-require__col-list_pr">
                    <?php while ( have_rows( $vacancies_list ) ) { the_row(); ?>
