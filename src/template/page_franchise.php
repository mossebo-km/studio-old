      ...
      <div class="row">
        ...
        <div class="col-md-6 col-12">
          ...
          <div class="franchise-page-feedback__youtube-player">
            <div class="youtube-player" data-youtube-player-src-img="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/frachise-page-feedback/__youtube-player/franchise-page-feedback__youtube-player-img-preview.jpg" data-youtube-player-id="x6H4trs4yDc">
          ...
          <div class="franchise-page-feedback__about-us-write">
            <div class="row">
              <div class="franchise-page-feedback__about-us-write-col col">
                <img class="franchise-page-feedback__about-us-write-img" src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/frachise-page-feedback/__about-us-write/franchise-page-feedback__about-us-write-img-1.png" alt="РБК">
                <div class="franchise-page-feedback__about-us-write-text">Победитель конкурса РБК</div>
              </div>
              <div class="franchise-page-feedback__about-us-write-col col">
                <img class="franchise-page-feedback__about-us-write-img" src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/frachise-page-feedback/__about-us-write/franchise-page-feedback__about-us-write-img-2.png" alt="ТНТ">
                <div class="franchise-page-feedback__about-us-write-text">Реклама Mossebo говорит голосом «Школы ремонта» на ТНТ</div>
              </div>
              <div class="franchise-page-feedback__about-us-write-col col">
                <img class="franchise-page-feedback__about-us-write-img" src="<?php echo get_template_directory_uri(); ?>/dir/img/main_page/abous_us_write/7.svg" alt="Лучшие световые решения для интерьера">
  ...
  <div class="panorama" data-pano-mobile-src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/franchise-pano/__office_mobile.jpg">
    <div class="panorama-view">
      <div class="panorama-container">
        <img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/franchise-pano/__office.jpg" usemap="hotspots" data-width="2168" data-height="500" alt="Наши офисы" />
      </div>
    </div>
  </div>
</div>
...
<div class="franchise-your-profit container-fluid">
  ...
  <div class="franchise-your-profit__img"><img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/franchise-your-profit__img/franchise-your-profit__img.svg" alt="Сколько вы будете зарабатывать"></div>
...
<div class="clients-find-us container-fluid">
  ...
  <div class="row align-item-center">
    <div class="col-xl-4 offset-xl-1">
      <div class="row">
        <div class="clients-find-us__row col-12">
          <div class="clients-find-us__row-img_mobile"><img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/clients-find-us/__office/__office-1.jpg" alt="«Выращиваем» клиента"></div>
        ...
        <div class="clients-find-us__row col-12">
          <div class="clients-find-us__row-img_mobile"><img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/clients-find-us/__office/__office-2.jpg" alt="«Выращиваем» клиента"></div>
        ...
        <div class="clients-find-us__row col-12">
          <div class="clients-find-us__row-img_mobile"><img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/clients-find-us/__office/__office-3.jpg" alt="«Выращиваем» клиента"></div>
    ...
    <div class="clients-find-us__img clients-find-us__img_pr-0 col-xl-7">
      <img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/clients-find-us/__office/__office.jpg" alt="Офис">
    </div>
  </div>
</div>
    ...
    <div class="row">
      <div class="col text-center">
        ...
        <div class="franchise-brand-style__img">
          <img class="franchise-brand-style__img_desctop" src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/franchise-brand-style/franchise-brand-style.png" alt="Единый фирменный стиль по всему миру">
          <img class="franchise-brand-style__img_mobile" src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/franchise-brand-style/franchise-brand-style_mobile.png" alt="Единый фирменный стиль по всему миру">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row align-item-center">
      ...
      <div class="col-md-4 col-12 franchise-superiority__numer-one_col-2">
        <div class="franchise-superiority__number-one-img">
          <img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/franchise-superiority/franchise-superiority__number-one-img.jpg" alt="Превосходство Mossebo над другими">
        </div>
      </div>
    ...
    <div class="row">
      <div class="franchise-superiority__business-start-col col-lg-4 col-md-4 col-sm-6">
        <div class="franchise-superiority__business-start-col-img">
          <img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/franchise-superiority/__business-start/1.svg" alt="Обучение в Санкт-Петербурге">
        </div>
      ...
      <div class="franchise-superiority__business-start-col col-lg-4 col-md-4 col-sm-6">
        <div class="franchise-superiority__business-start-col-img">
          <img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/franchise-superiority/__business-start/5.svg" alt="Офис">
        </div>
      ...
      <div class="franchise-superiority__business-start-col col-lg-4 col-md-4 col-sm-6">
        <div class="franchise-superiority__business-start-col-img">
          <img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/franchise-superiority/__business-start/2.svg" alt="Брендирование">
        </div>
      ...
      <div class="franchise-superiority__business-start-col col-lg-4 col-md-4 col-sm-6">
        <div class="franchise-superiority__business-start-col-img">
          <img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/franchise-superiority/__business-start/4.svg" alt="Первичный рекламный взнос">
        </div>
      ...
      <div class="franchise-superiority__business-start-col col-lg-4 col-md-4 col-sm-6">
        <div class="franchise-superiority__business-start-col-img">
          <img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/franchise-superiority/__business-start/3.svg" alt="Посещение объектов">
        </div>
...
<div class="franchise-pano franchise-pano_bg-gray">
  ...
  <div class="panorama" data-pano-mobile-src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/franchise-pano/__portfolio_mobile.jpg">
    <div class="panorama-view">
      <div class="panorama-container">
        <img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/franchise-pano/__portfolio.jpg" usemap="hotspots" data-width="1887" data-height="600" alt="Наши офисы" />
      </div>
    </div>
  </div>
</div>
...
<div class="clients-find-us container-fluid">
  ...
  <div class="row align-item-center">
    <div class="clients-find-us__img clients-find-us__img_pr-0 clients-find-us__img_pl-0 col-xl-7">
      <img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/clients-find-us/__work/__work.jpg" alt="Открыть бизнес под брендом Mossebo выгодно, потому что мы:">
    </div>
    <div class="col-xl-4 offset-xl-1">
      <div class="row">
        <div class="clients-find-us__row col-12">
          <div class="clients-find-us__row-img_mobile"><img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/clients-find-us/__work/__work-1.jpg" alt="«Выращиваем» клиента"></div>
        ...
        <div class="clients-find-us__row col-12">
          <div class="clients-find-us__row-img_mobile"><img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/clients-find-us/__work/__work-2.jpg" alt="«Выращиваем» клиента"></div>
        ...
        <div class="clients-find-us__row col-12">
          <div class="clients-find-us__row-img_mobile"><img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/clients-find-us/__work/__work-3.jpg" alt="«Выращиваем» клиента"></div>
  ...
  <div class="franchise-social__carousel owl-carousel">
    ...
    <div class="item">
      <a href="https://www.instagram.com/remont.design/" target="_blank">
        <div class="franchise-social__carousel-icon">
          <img src="<?php echo get_template_directory_uri(); ?>/dir/img/icon/social/inst.svg" alt="Inst">
        </div>
        <div class="franchise-social__carousel-img">
          <img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/franchise-social/__carousel-img/inst.jpg" alt="Inst">
        </div>
      </a>
    </div>
    <!-- FaceBook -->
    <div class="item">
      <a href="https://www.facebook.com/mossebodesign/" target="_blank">
        <div class="franchise-social__carousel-icon">
          <img src="<?php echo get_template_directory_uri(); ?>/dir/img/icon/social/fb.svg" alt="facebook">
        </div>
        <div class="franchise-social__carousel-img">
          <img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/franchise-social/__carousel-img/fb.jpg" alt="Страница вк">
        </div>
      </a>
    </div>
    <!-- VK -->
    <div class="item">
      <a href="https://vk.com/design_mossebo" target="_blank">
        <div class="franchise-social__carousel-icon">
          <img src="<?php echo get_template_directory_uri(); ?>/dir/img/icon/social/vk.svg" alt="vk">
        </div>
        <div class="franchise-social__carousel-img">
          <img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/franchise-social/__carousel-img/vk.jpg" alt="Vkontakte">
        </div>
      </a>
    </div>
    <!-- youtube -->
    <div class="item">
      <a href="https://www.youtube.com/channel/UCmYjYyeZDuFb9hOgEUNYJuQ/featured" target="_blank">
        <div class="franchise-social__carousel-icon">
          <img src="<?php echo get_template_directory_uri(); ?>/dir/img/icon/social/youtube-logo.svg" alt="youtube">
        </div>
        <div class="franchise-social__carousel-img">
          <img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/franchise-social/__carousel-img/you.jpg" alt="YouTube">
        </div>
      </a>
    </div>
    <!-- OK -->
    <div class="item">
      <a href="https://ok.ru/group/53291776606394" target="_blank">
        <div class="franchise-social__carousel-icon">
          <img src="<?php echo get_template_directory_uri(); ?>/dir/img/icon/social/odn.svg" alt="OK">
        </div>
        <div class="franchise-social__carousel-img">
          <img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/franchise-social/__carousel-img/ok.jpg" alt="OK">
        </div>
      </a>
    </div>
  </div>
...
<div class="franchise-social-rating container-fluid">
  ...
  <div class="row align-item-center">
    <div class="franchise-social-rating__rate col-sm-6">
      <img src="<?php echo get_template_directory_uri(); ?>/dir/img/franchise/franchise-social-rating/rate.png" alt="График социальных сетей">
    </div>
