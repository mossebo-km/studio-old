        ...
        <div class="col-xl-10 offset-xl-1 col-12">
            <div class="row">
                ...
                <div class="col-md-6 col-12">
                    <!-- Sub title -->
                    <h2 class="franchise-page-feedback__subtitle">Бизнес по дизайну интерьера с гарантией входящих
                        заявок</h2>
                    <!-- YouTube player -->
                    ...
                    <div class="franchise-page-feedback__about-us-write">
                        <div class="row">
                            <div class="franchise-page-feedback__about-us-write-col col">
                                <img class="franchise-page-feedback__about-us-write-img"
                            ...
                            <div class="franchise-page-feedback__about-us-write-col col">
                                <img class="franchise-page-feedback__about-us-write-img"
                                     ...
                                     alt="ТНТ">
                                <div class="franchise-page-feedback__about-us-write-text">Реклама Mossebo говорит
                                    голосом «Школы ремонта» на ТНТ
                                </div>
                            </div>
                            <div class="franchise-page-feedback__about-us-write-col col">
                                <img class="franchise-page-feedback__about-us-write-img"
                                ...
                                <div class="franchise-page-feedback__about-us-write-text">Премии “Лидер отрасли” и
...
<div class="franchise-page-map">
    ...
    <div class="franchise-page-map__info">
        <div class="franchise-page-map__info-inner">
            ...
            <div class="franchise-page-map__info-subtitle">Офисы Mossebo открыты уже в 19 городах, 14 в процессе
                запуска.
            </div>
            <div class="franchise-page-map__info-locations"><span class="text-primary">Россия:</span> Москва,
                Санкт-Петербург, Волгоград, Тюмень, Самара, Ростов-на-Дону, Уссурийск, Оренбург, Тула, Уфа, Пенза.
            </div>
            <div class="franchise-page-map__info-locations"><span class="text-primary">Мир:</span> Бишкек, Минск,
                Ташкент, Астана.
            </div>
        </div>
...
<div class="franchise-page-feauteres-world container-fluid">
    <div class="row">
        <div class="franchise-page-feauteres-world__grid col col-sm-4 col-12">
            ...
            <div class="franchise-page-feauteres-world__grid-description">Крупнейшая компания по дизайну интерьера в
                России и СНГ
            </div>
        </div>
        <div class="franchise-page-feauteres-world__grid col col-sm-4 col-12">
            <div class="franchise-page-feauteres-world__grid-title">8 часовых поясов</div>
            <div class="franchise-page-feauteres-world__grid-description">Мы адаптируем работу call-центра и маркетинга
                для разных часовых поясов
            </div>
        </div>
        <div class="franchise-page-feauteres-world__grid col col-sm-4 col-12">
            <div class="franchise-page-feauteres-world__grid-title">Работаем в пяти странах</div>
            <div class="franchise-page-feauteres-world__grid-description">Мы проверили бизнес в разных культурах,
                народах и этнических местностях
            </div>
        </div>
    </div>
</div>
    ...
    if (have_rows('franchise-page__reviews')): ?>
        <div class="reviews-video container">
            ...
            <div class="reviews-video__article">
                ...
                <div class="reviews-video__article-text">Франчайзи Mossebo проходят обучающий курс в Санкт-Петербурге и
                    получают поддержку от управляющей компании на всех этапах работ. С каждым франчайзинговым филиалом
                    работает личный аккаунт менеджер, готовый ответить на все возникающие вопросы.
                </div>
                <div class="reviews-video__article-text">Мы не бросаемся обещаниями, громкими словами и голословными
                    титулами — безупречная репутация Mossebo говорит сама за себя. Франчайзи Mossebo, уже прошедший
                    обучающий курс, открыто оставляют свои отзывы о компании.
                </div>
            </div>
        </div>
    <?php endif; ?>
...
<div class="franchise-call-to-action franchise-call-to-action_filials-bg container-fluid">
    <div class="franchise-call-to-action__title"><span class="text-primary">Больше</span> филиалов в городе —<br> <span
            class="text-primary">лучше</span> владельцу бизнеса и клиентам
    </div>
    <div class="franchise-call-to-action__description">Технология ведения бизнеса по франшизе Mossebo позволяет
        открывать несколько филиалов в одном городе
    </div>
    <button class="franchise-call-to-action__btn franchise-page-feedback-form-modal btn btn_1" type="button">Узнайте
        подробнее
    </button>
</div>
...
<div class="franchise-pano">
    <div class="container-fluid">
        ...
        <div class="franchise-pano__description">Все офисы Mossebo оформляются в едином стиле и оснащаются оборудованием
            и мебелью от проверенных поставщиков. У вас будет все необходимое для заключения сделок
        </div>
    </div>
    <div class="panorama"
        ...
        <div class="panorama-view">
            <div class="panorama-container">
                <img src="<?php echo THEME_DIR; ?>/assets/images/franchise/franchise-pano/__office.jpg"
                     usemap="hotspots" data-width="2168" data-height="500" alt="Наши офисы"/>
            </div>
        </div>
    </div>
</div>
...
<div class="franchise-your-profit container-fluid">
    ...
    <div class="franchise-your-profit__img"><img
            src="<?php echo THEME_DIR; ?>/assets/images/franchise/franchise-your-profit__img/franchise-your-profit__img.svg"
            alt="Сколько вы будете зарабатывать"></div>
    <div class="franchise-your-profit__description">Это ваша ежемесячная прибыль через 1 год после запуска студии при
        условии соблюдения всех регламентов франшизы
    </div>
    <div class="franchise-your-profit__numbers">
    <span class="franchise-your-profit__numbers-inner">
      <span class="text-primary">* 22 455</span> EUR, <span class="text-primary">25 000</span> USD, <span
            class="text-primary">8 173 362</span> KZT, <span class="text-primary">650 561</span> UAH, <span
...
<div class="franchise-call-to-action franchise-call-to-action_business-plan-bg container-fluid">
    ...
    <div class="franchise-call-to-action__description">Детальная модель расходов и доходов филиала Mossebo с учетом
        экономических и демографических данных вашего города
    </div>
    <button class="franchise-call-to-action__btn franchise-page-feedback-form-modal btn btn_1" type="button">Получить
    </button>
</div>
        ...
        <div class="col-xl-4 offset-xl-1">
            <div class="row">
                <div class="clients-find-us__row col-12">
                    <div class="clients-find-us__row-img_mobile"><img
                            src="<?php echo THEME_DIR; ?>/assets/images/franchise/clients-find-us/__office/__office-1.jpg"
                            alt="«Выращиваем» клиента"></div>
                    <div class="clients-find-us__title"><span class="text-bold">«Выращиваем»</span> клиента</div>
                    <div class="clients-find-us__description">Централизованно собираем запросы на дизайн интерьера с
                        собственных площадок и онлайн рекламы
                    </div>
                </div>
                <div class="clients-find-us__row col-12">
                    <div class="clients-find-us__row-img_mobile"><img
                            src="<?php echo THEME_DIR; ?>/assets/images/franchise/clients-find-us/__office/__office-2.jpg"
                            alt="«Выращиваем» клиента"></div>
                    <div class="clients-find-us__title"><span class="text-bold">«Прогреваем»</span> клиента</div>
                    <div class="clients-find-us__description">Вы получаете целевую заявку на дизайн интерьера и готового
                        к встрече в офисе клиента через CRM-систему
                    </div>
                </div>
                <div class="clients-find-us__row col-12">
                    <div class="clients-find-us__row-img_mobile"><img
                            src="<?php echo THEME_DIR; ?>/assets/images/franchise/clients-find-us/__office/__office-3.jpg"
                            alt="«Выращиваем» клиента"></div>
                    <div class="clients-find-us__title"><span class="text-bold">«Передаём»</span> согласного на встречу
                        клиента вам
                    </div>
                    <div class="clients-find-us__description">Вы получите не просто бренд пакет, а уже напечатанную и
                        готовую для работы продукцию со знаком обслуживания Mossebo
                    </div>
                </div>
            </div>
        </div>
        <div class="clients-find-us__img clients-find-us__img_pr-0 col-xl-7">
            <img src="<?php echo THEME_DIR; ?>/assets/images/franchise/clients-find-us/__office/__office.jpg"
                 alt="Офис">
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col text-center">
                <div class="franchise-title franchise-brand-style__main-title">Единый фирменный стиль по всему миру
                </div>
                <div class="franchise-brand-style__description">Каждая деталь фирменного стиля помогает в заключении
                    сделок. Вы получите уже готовый и напечатанный бренд пакет сразу после обучения.
                </div>
                <div class="franchise-brand-style__img">
                    <img class="franchise-brand-style__img_desctop"
                         src="<?php echo THEME_DIR; ?>/assets/images/franchise/franchise-brand-style/franchise-brand-style.png"
                         alt="Единый фирменный стиль по всему миру">
                    <img class="franchise-brand-style__img_mobile"
                         src="<?php echo THEME_DIR; ?>/assets/images/franchise/franchise-brand-style/franchise-brand-style_mobile.png"
                         alt="Единый фирменный стиль по всему миру">
                </div>
            </div>
        </div>
        ...
        <div class="row align-item-center">
            <div class="col-md-4 col-12 franchise-superiority__numer-one_col-1 text-right">
                <div class="franchise-superiority__numer-one-row">
                    ...
                    <div class="franchise-superiority__numer-one-row-description">Единственная компания дизайна и
                        ремонта с офисами в России и СНГ
                    </div>
                </div>
                <div class="franchise-superiority__numer-one-row">
                    <div class="franchise-superiority__numer-one-row-title">Нет сезонности</div>
                    <div class="franchise-superiority__numer-one-row-description">Нет зависимости от сезонности и
                        кризиса, даем заявки круглый год
                    </div>
                </div>
                <div class="franchise-superiority__numer-one-row">
                    <div class="franchise-superiority__numer-one-row-title">Прибыль от 1 500 000 рублей</div>
                    <div class="franchise-superiority__numer-one-row-description">Франчайзи выходит на такую прибыль уже
                        через 1 год работы
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-12 franchise-superiority__numer-one_col-2">
                <div class="franchise-superiority__number-one-img">
                    <img
                        src="<?php echo THEME_DIR; ?>/assets/images/franchise/franchise-superiority/franchise-superiority__number-one-img.jpg"
                        alt="Превосходство Mossebo над другими">
                </div>
            </div>
            <div class="col-md-4 col-12 franchise-superiority__numer-one_col-3">
                <div class="franchise-superiority__numer-one-row">
                    ...
                    <div class="franchise-superiority__numer-one-row-description">Самые крупные среди конкурентов
                        площадки в социальных сетях
                    </div>
                </div>
                <div class="franchise-superiority__numer-one-row">
                    <div class="franchise-superiority__numer-one-row-title">Поддержка 24/7</div>
                    <div class="franchise-superiority__numer-one-row-description">Поддержка в продажах, юридическое и
                        маркетинговое сопровождение
                    </div>
                </div>
                <div class="franchise-superiority__numer-one-row">
                    <div class="franchise-superiority__numer-one-row-title">Не берем процент от сделок</div>
                    <div class="franchise-superiority__numer-one-row-description">Не ограничиваем рост филиала
                        отчислениями со сделок
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="franchise-superiority__business-start-col col-lg-4 col-md-4 col-sm-6">
                <div class="franchise-superiority__business-start-col-img">
                    <img
                        src="<?php echo THEME_DIR; ?>/assets/images/franchise/franchise-superiority/__business-start/1.svg"
                        alt="Обучение в Санкт-Петербурге">
                </div>
                <div class="franchise-superiority__business-start-col-title"><span
                        class="franchise-superiority__business-start-col-title-counter">1.</span>Обучение в
                    Санкт-Петербурге
                </div>
            ...
            <div class="franchise-superiority__business-start-col col-lg-4 col-md-4 col-sm-6">
                <div class="franchise-superiority__business-start-col-img">
                    <img
                        src="<?php echo THEME_DIR; ?>/assets/images/franchise/franchise-superiority/__business-start/5.svg"
                        alt="Офис">
                </div>
                <div class="franchise-superiority__business-start-col-title"><span
                        class="franchise-superiority__business-start-col-title-counter">2.</span>Офис
                </div>
                <ul class="franchise-superiority__business-start-col-list">
            ...
            <div class="franchise-superiority__business-start-col col-lg-4 col-md-4 col-sm-6">
                <div class="franchise-superiority__business-start-col-img">
                    <img
                        src="<?php echo THEME_DIR; ?>/assets/images/franchise/franchise-superiority/__business-start/2.svg"
                        alt="Брендирование">
                </div>
                <div class="franchise-superiority__business-start-col-title"><span
                        class="franchise-superiority__business-start-col-title-counter">3.</span> Брендирование
                </div>
                <ul class="franchise-superiority__business-start-col-list">
                    <li>Ремонт офиса</li>
            ...
            <div class="franchise-superiority__business-start-col col-lg-4 col-md-4 col-sm-6">
                <div class="franchise-superiority__business-start-col-img">
                    <img
                        src="<?php echo THEME_DIR; ?>/assets/images/franchise/franchise-superiority/__business-start/4.svg"
                        alt="Первичный рекламный взнос">
                </div>
                <div class="franchise-superiority__business-start-col-title"><span
                        class="franchise-superiority__business-start-col-title-counter">4.</span>Первичный маркетинговый
                    платеж
                </div>
                <ul class="franchise-superiority__business-start-col-list">
                    <li>100 000 рублей (Направлен на привлечение клиентов, а также на повышение узнаваемости бренда
                        Mossebo и создание органического спроса)
                    </li>
                </ul>
            </div>
            <div class="franchise-superiority__business-start-col col-lg-4 col-md-4 col-sm-6">
                <div class="franchise-superiority__business-start-col-img">
                    <img
                        src="<?php echo THEME_DIR; ?>/assets/images/franchise/franchise-superiority/__business-start/3.svg"
                        alt="Посещение объектов">
                </div>
                <div class="franchise-superiority__business-start-col-title"><span
                        class="franchise-superiority__business-start-col-title-counter">5.</span>Найм дизайнеров
                </div>
                <ul class="franchise-superiority__business-start-col-list">
...
<div class="franchise-call-to-action franchise-call-to-action_skill-bg container-fluid">
    ...
    <div class="franchise-call-to-action__description">Mossebo — это бизнес для тех, кто хочет зарабатывать деньги, а не
        работать на стройке
    </div>
    <button class="franchise-call-to-action__btn franchise-page-feedback-form-modal btn btn_1" type="button">
        Присоединиться к mossebo
    </button>
</div>
    ...
    <div class="row">
        ...
        <div class="franchise-require__col col-sm-6 col-12">
            ...
            <ul class="franchise-require__col-list franchise-require__col-list_pr">
                <li>Способность обеспечивать бизнес финансированием на первых этапах в соответствии с технологией
                    запуска
                </li>
...
<div class="franchise-pano franchise-pano_bg-gray">
    ...
    <div class="panorama"
         data-pano-mobile-src="<?php echo THEME_DIR; ?>/assets/images/franchise/franchise-pano/__portfolio_mobile.jpg">
        <div class="panorama-view">
            <div class="panorama-container">
                <img src="<?php echo THEME_DIR; ?>/assets/images/franchise/franchise-pano/__portfolio.jpg"
                     usemap="hotspots" data-width="1887" data-height="600" alt="Наши офисы"/>
            </div>
        </div>
    </div>
</div>
...
<div class="clients-find-us container-fluid">
    <div class="row">
        <div class="col-12 text-center">
            <div class="franchise-title clients-find-us__title-main">Открыть бизнес под брендом Mossebo выгодно,<br>
                <span class="text-primary">потому что мы:</span></div>
        </div>
    </div>
    <div class="row align-item-center">
        <div class="clients-find-us__img clients-find-us__img_pr-0 clients-find-us__img_pl-0 col-xl-7">
            <img src="<?php echo THEME_DIR; ?>/assets/images/franchise/clients-find-us/__work/__work.jpg"
                 alt="Открыть бизнес под брендом Mossebo выгодно, потому что мы:">
        </div>
        <div class="col-xl-4 offset-xl-1">
            <div class="row">
                <div class="clients-find-us__row col-12">
                    <div class="clients-find-us__row-img_mobile"><img
                            src="<?php echo THEME_DIR; ?>/assets/images/franchise/clients-find-us/__work/__work-1.jpg"
                            alt="«Выращиваем» клиента"></div>
                    <div class="clients-find-us__title clients-find-us__title_bold">Устранили сезонность</div>
                    <div class="clients-find-us__description">Мы находим и передаем вам контакты клиентов каждый месяц,
                        включая летний и зимний сезоны
                    </div>
                </div>
                <div class="clients-find-us__row col-12">
                    <div class="clients-find-us__row-img_mobile"><img
                            src="<?php echo THEME_DIR; ?>/assets/images/franchise/clients-find-us/__work/__work-2.jpg"
                            alt="«Выращиваем» клиента"></div>
                    <div class="clients-find-us__title clients-find-us__title_bold">Снизили стартовые вложения</div>
                    <div class="clients-find-us__description">Технология Mossebo позволяет заработать максимальную
                        прибыль с инвестиций по сравнению с рынками общественного питания, одежды и детских товаров
                    </div>
                </div>
                <div class="clients-find-us__row col-12">
                    <div class="clients-find-us__row-img_mobile"><img
                            src="<?php echo THEME_DIR; ?>/assets/images/franchise/clients-find-us/__work/__work-3.jpg"
                            alt="«Выращиваем» клиента"></div>
                    <div class="clients-find-us__title clients-find-us__title_bold">Не работаем в сегменте «эконом»
                    </div>
                    <div class="clients-find-us__description">В 2015 году в кризис на территории России введено в
                        эксплуатацию рекордное число новостроек, в 2016 году заключено рекордное количество ДДУ. Среди
                        этих людей мы найдем и передадим вам заказы среднего и VIP сегмента
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="franchise-social__carousel owl-carousel">
        ...
        <div class="item">
            <a href="https://www.instagram.com/remont.design/" target="_blank">
                ...
                <div class="franchise-social__carousel-img">
                    <img src="<?php echo THEME_DIR; ?>/assets/images/franchise/franchise-social/__carousel-img/inst.jpg"
                         alt="Inst">
                </div>
            </a>
        </div>
        ...
        <div class="item">
            <a href="https://www.facebook.com/mossebodesign/" target="_blank">
                ...
                <div class="franchise-social__carousel-img">
                    <img src="<?php echo THEME_DIR; ?>/assets/images/franchise/franchise-social/__carousel-img/fb.jpg"
                         alt="Страница вк">
                </div>
            </a>
        </div>
        ...
        <div class="item">
            <a href="https://vk.com/design_mossebo" target="_blank">
                ...
                <div class="franchise-social__carousel-img">
                    <img src="<?php echo THEME_DIR; ?>/assets/images/franchise/franchise-social/__carousel-img/vk.jpg"
                         alt="Vkontakte">
                </div>
            </a>
        </div>
        ...
        <div class="item">
            <a href="https://www.youtube.com/channel/UCmYjYyeZDuFb9hOgEUNYJuQ/featured" target="_blank">
                ...
                <div class="franchise-social__carousel-img">
                    <img src="<?php echo THEME_DIR; ?>/assets/images/franchise/franchise-social/__carousel-img/you.jpg"
                         alt="YouTube">
                </div>
            </a>
        </div>
        ...
        <div class="item">
            <a href="https://ok.ru/group/53291776606394" target="_blank">
                ...
                <div class="franchise-social__carousel-img">
                    <img src="<?php echo THEME_DIR; ?>/assets/images/franchise/franchise-social/__carousel-img/ok.jpg"
                         alt="OK">
                </div>
            </a>
        </div>
...
<div class="franchise-social-rating container-fluid">
    ...
    <div class="row align-item-center">
        <div class="franchise-social-rating__rate col-sm-6">
            <img src="<?php echo THEME_DIR; ?>/assets/images/franchise/franchise-social-rating/rate.png"
                 alt="График социальных сетей">
        </div>
        <div class="franchise-social-rating__info col-sm-4">
            <div class="franchise-social-rating__info-year">2019 год</div>
            <div class="franchise-social-rating__info-description">Поток аудиториии из новых каналов: видеоплатформы и
                мессенджеры
            </div>
        </div>
    </div>
