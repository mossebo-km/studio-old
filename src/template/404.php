    ...
    <div class="container error404__container">
      <div class="row error404__row align-item-center">
        <div class="col-12">
          ...
          <div class="error404__description">Сожалеем, но вы нашли неработающую страницу или ссылку сайта. Напишите в отдел поддержки на <a href="mailto:support@mossebo.ru">support@mossebo.ru</a>, и мы поможем найти потерянное!</div>
