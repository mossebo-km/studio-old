...
<div class="reviews-about container">
	<div class="reviews-about__row_align-center row">
		<div class="reviews-about__col col-md-4 offset-md-1">
			<img src="<?php echo THEME_DIR; ?>/assets/images/page-reviews/reviews-about__img.svg" alt="Отзывы Mossebo" class="reviews-about__img">
		</div>
		<div class="reviews-about__col col-md-7">
			...
			<div class="reviews-about__text">Мы уверены, что лучшая реклама — это благодарность клиентов. Мы не скрываемся за текстовыми отзывами о компании Mossebo — мы делимся честным мнением наших заказчиков и публикуем реальные видеоотзывы. Смотрите отзывы о работе Mossebo — международного бренда по дизайну и ремонту интерьеров.</div>
		</div>
	</div>
</div>
				...
				<div class="owl-carousel">
					...
					<?php foreach ($rows as $row): ?>
						<div class="reviews-video__item item">
							...
							<div class="reviews-video__item-title"><?php echo $row[ 'main_page_youtube_section_item_option_name' ]; ?></div>
						</div>
					<?php endforeach; ?>
				</div>
			</div>
			...
			<div class="row">
				...
				foreach ($rows as $row): ?>
					<div class="reviews-video__pagination-grid col-md-4" data-carousel-index="<?php echo $carouselIndex; ?>">
						<div class="reviews-video__pagination-preview" style="background-image: url(<?php echo $row[ 'main_page_youtube_section_item_option_img' ]; ?>)"></div>
						<div class="reviews-video__pagination-grid-title"><?php echo $row[ 'main_page_youtube_section_item_option_name' ]; ?></div>
						<div class="reviews-video__pagination-grid-description"><?php echo $row[ 'main_page_youtube_section_item_option_subname' ]; ?></div>
					</div>
				<?php
				$carouselIndex++;
				endforeach; ?>
...
<div class="reviews__service container">
	...
	<div class="row">
		<div class="reviews__service-item col-xl-4 col-12">
			<div class="reviews__service-col" style="background-image: url(<?php echo THEME_DIR; ?>/assets/images/page-reviews/reviews__service/1.jpg);">
				<div class="reviews__service-inner">
					...
					<img src="<?php echo THEME_DIR; ?>/assets/images/page-reviews/reviews__service/icons/cottage_renovation.svg" alt="" class="reviews__service-img">
		...
		<div class="reviews__service-item col-xl-4 col-12">
			<div class="reviews__service-col" style="background-image: url(<?php echo THEME_DIR; ?>/assets/images/page-reviews/reviews__service/2.jpg);">
				<div class="reviews__service-inner">
					<div class="reviews__service-link-arrow">
						<a href="/remont-ofisov/" class="link-arrow link-arrow_white">подробнее</a>
					</div>
					<img src="<?php echo THEME_DIR; ?>/assets/images/page-reviews/reviews__service/icons/office_renovation.svg" alt="" class="reviews__service-img">
		...
		<div class="reviews__service-item col-xl-4 col-12">
			<div class="reviews__service-col" style="background-image: url(<?php echo THEME_DIR; ?>/assets/images/page-reviews/reviews__service/4.jpg);">
				<div class="reviews__service-inner">
					<div class="reviews__service-link-arrow">
						<a href="/pomoshh-v-priemke-kvartiryi-u-zastroyshhika/" class="link-arrow link-arrow_white">подробнее</a>
					</div>
					<img src="<?php echo THEME_DIR; ?>/assets/images/page-reviews/reviews__service/icons/help_getting.svg" alt="" class="reviews__service-img">
