    ...
    <div class="container-fluid">
      ...
      <div class="row align-item-center">
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
          <h3>Международная ремонтно-дизайнерская компания Mossebo</h3>
          <p>546 семей сделали ремонт в своих квартирах и коттеджах вместе с Mossebo в 2016 году. Наши филиалы расположены в Москве, Минске, Санкт-Петербурге, Волгограде, Бишкеке, Тюмени, Краснодаре и других городах России и СНГ.</p>
          <p>Мы делаем комплексный ремонт и создаем дизайн интерьера. От квартиры студии до загородного коттеджа или офиса. Судя по темпам роста и отзывам — делаем хорошо.</p>
        </div>
      </div>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-xl-8 offset-xl-2">
          <p><span class="text-primary text-bold">Россия:</span> Москва, Санкт-Петербург, Волгоград, Ставрополь, Краснодар, Тюмень, Челябинск, Ульяновск, Владивосток, Самара, Ростов-на-Дону, Воронеж, Новосибирск.</p>
          <p><span class="text-primary text-bold">Мир:</span> Бишкек, Минск.</p>
        </div>
      </div>
