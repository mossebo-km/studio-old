  ...
  <div class="container-fluid">
    ...
    <div class="social-inst">
      <div class="row">
        ...
        <div class="col-xl-6 text-left"><img class="inst-icon" height="50" width="50" src="<?php echo get_template_directory_uri(); ?>/dir/img/icon/instagram_section.svg" alt="instagram"></div>
    ...
    <div class="social-youtube">
      ...
      <!-- Title -->
      <div class="row">
        <div class="col-xl-6 text-left"><img class="inst-icon" height="50" width="50" src="<?php echo get_template_directory_uri(); ?>/dir/img/icon/social/youtube-logo.svg" alt="YouTube"></div>
