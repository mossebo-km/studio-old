                    ...
                    <div class="content-left">
                        <div class="cingle-page-news-main">
                            <div class="row top-info-row">
                                <div class="col-xl-6 text-left"><span class="data-news"><?php echo the_date(); ?></span>
                                </div>
                                <div class="col-xl-6 text-right text-left-xs"><a href="/novosti/" class="link-arrow">Посмотреть
                                        всё новости</a></div>
                            </div>
