        ...
        <div class="col-md-10 offset-md-1">
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <h2 class="page-banner__sub-title page-banner__sub-title_theme-color-black"><span
                            class="text-primary">Сохрани от 70 000 до 300 000 рублей</span> на новую<br> машину, будущий
                        ремонт или долгожданный отпуск</h2>
                </div>
    ...
    <div class="how-getting__youtube-player row">
        <div class="col-md-8 offset-md-2">
            <div class="youtube-player"
                 data-youtube-player-src-img="<?php echo THEME_DIR; ?>/assets/images/service/help-getting/how-getting/youtube-player__tum.jpg"
                 data-youtube-player-id="3bkb7-U-DwY">
...
<div class="why-help container">
    ...
    <div class="why-help__description">Визуальные дефекты можно обнаружить, но для поиска серьезных ошибок нужна помощь
        строителя и профессиональное оборудование. <b>Только он сможет проверить:</b></div>
    <div class="feauteres-grids row">
        <div class="feauteres-grids__col col-sm-4">
            ...
            <div class="feauteres-grids__col-title"><span class="feauteres-grids__col-title-count">1.</span> Состояние
                стен
            </div>
            <div class="feauteres-grids__col-description">С помощью тепловизора стены проверяются на предмет наличия
                трещин и промерзания углов.
            </div>
        </div>
        <div class="feauteres-grids__col col-sm-4">
            <i class="feauteres-grids__col-icon feauteres-grids__col-icon_help-getting-2"></i>
            <div class="feauteres-grids__col-title"><span class="feauteres-grids__col-title-count">2.</span> Качество
                стяжки пола
            </div>
            <div class="feauteres-grids__col-description">Замеряется толщина пола, выявляется возможное наличие пустот в
                стяжке.
            </div>
        </div>
        <div class="feauteres-grids__col col-sm-4">
            ...
            <div class="feauteres-grids__col-description">Электропроводка и электрощиток обследуются на предмет
                несоответствия нормам безопасности.
            </div>
        </div>
        <div class="feauteres-grids__col col-sm-4">
            <i class="feauteres-grids__col-icon feauteres-grids__col-icon_help-getting-4"></i>
            <div class="feauteres-grids__col-title"><span class="feauteres-grids__col-title-count">4.</span> Исправность
                системы отопления
            </div>
            <div class="feauteres-grids__col-description">Выявляются возможные дефекты в установке радиаторов и труб
                отопления.
            </div>
        </div>
        <div class="feauteres-grids__col col-sm-4">
            <i class="feauteres-grids__col-icon feauteres-grids__col-icon_help-getting-5"></i>
            <div class="feauteres-grids__col-title"><span class="feauteres-grids__col-title-count">5.</span> Точность
                метража
            </div>
            <div class="feauteres-grids__col-description">Чтобы избежать возможных доплат за «лишние» метры,
                производится контрольный замер площади квартиры.
            </div>
        </div>
    </div>
...
<div class="indicators-feauteres container">
    ...
    <div class="indicators-feauteres__description">Ваш застройщик не сдал дом вовремя? Предлагал серые схемы? Не
        выполнил условия по договору? Тогда у вас нет оснований верить качеству его работы.
    </div>
    <!-- feauteres -->
    ...
    <div class="indicators-feauteres__bottom-row row">
        <div class="col-md-7">
            <div class="section-title section-title_theme-1 indicators-feauteres__bottom-row-title">Если подписать акт
                приема-передачи — устранять все дефекты придется за свой счет!
            </div>
            <div class="indicators-feauteres__bottom-row-description">Пригласите на приемку профессионала и сохраните
                свое<br> время и деньги.
            </div>
        </div>
        <div class="col-md-5">
            <img class="indicators-feauteres__bottom-row-img"
                 src="<?php echo THEME_DIR; ?>/assets/images/service/help-getting/indicators-feauteres/indicators-feauteres__bottom-row-img.jpg"
                 alt="">
        </div>
    </div>
</div>
...
<div class="protect-you container">
    <div class="section-title section-title_theme-1 protect-you__title">Защитим вас от незаконных переплат за лишние
        метры
    </div>
    <div class="protect-you__row row">
        <div class="col-md-5">
            <img class="protect-you__img"
                 src="<?php echo THEME_DIR; ?>/assets/images/service/help-getting/protect-you/protect-you__img.png"
                 alt="">
        </div>
        <div class="col-md-6 offset-md-1">
            <div class="protect-you__text">Застройщики всегда включают в договор пункт о доплатах после обмера
                помещения. Только специалист сможет правильно составить план квартиры и высчитать жилую и общую площадь,
                сохранив ваш бюджет.
            </div>
        </div>
    </div>
