    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xl-7 contact-page-item-email">
                <p>
                    <a href="mailto:franchise@mossebo.ru">franchise@mossebo.ru</a> — по вопросам открытия филиала
                    mossebo<br>
                    ...
                    <a href="mailto:product@mossebo.market">product@mossebo.market</a> — для производителей мебели,
                    отделочных материалов и декора
                </p>
            </div>
        </div>
