            ...
            <div class="row">
              ...
              <div class="col-xl-3 col-lg-2 col-md-2">
                <a href="<?php echo get_home_url(); ?>">
                  <img src="<?php echo get_template_directory_uri(); ?>/dir/img/header/logo.svg" alt="Mossebo" class="footer-logo">
                </a>
              </div>
              ...
              <div class="col-xl-2 col-lg-3 col-md-3 footer-col-contacts">
                <div class="footer-col-contact__wrapper text-bold">
                  ...
                  if ( isset( $addres_footer ) && isset( $phone_footer ) ) { ?>
                    <address class="footer-adress text-center-sm text-center-xs footer-col-contacts-sm-3"><?php echo geoInit( 'address' ); ?></address>
                    <div class="footer-phone-block text-center-sm text-center-xs footer-col-contacts-sm-3 phone-geo ">
                      <div class="footer-phone"><a href="tel:<?php echo geoInit( 'phone' ); ?>"><?php echo geoInit( 'phone' ); ?></a></div>
              ...
              <div class="col-xl-4 col-lg-3 col-md-3">
                <div class="icon-social-link">
                  ...
                  <div class="item-social-link-icon">
                    ...
                    <iframe src="/wp-content/themes/mossebo/template/yell.html" frameborder="0" width="160" height="60" style="margin-top: 15px;"></iframe>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-xl-10 offset-xl-1 col-md-12">
                ...
                <div class="row">
                  <div class="col-xl-8">
                    <div class="copyright">
                      <div class="copyright__row">Copyright &copy; 2017 MOSSEBO | <a href="/politika-konfidentsialnosti/">Политика конфиденциальности</a> | <a href="/polozhenie-o-poryadke-hraneniya-i-zashhityi-personalnyih-dannyih-polzovateley/">Положение о порядке хранения и защиты персональных данных пользователей</a></div>
    ...
    <?php // franchise page
      ...
      <div class="feedback-form-modal-thank-page white-popup-block mfp-hide">
        ...
        <div class="tnx-vido">
          <div class="youtube-player feedback-form-modal-thank-page__youtube-player" data-youtube-player-src-img="http://img.youtube.com/vi/es-p_q1BHYo/maxresdefault.jpg" data-youtube-player-id="es-p_q1BHYo">
        ...
        <a href="<?php echo get_template_directory_uri(); ?>/mossebo.pdf" download class="btn btn_1 feedback-form-modal-thank-page__btn">Скачать презентацию</a>
      </div>
